...
const EditResume = () => {
  ...
  //TAKE BACK TO PREVIOUS FORM STATEOR TAKE BACK TO FIRST OR TO /DASHBOARD
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
  ...
  //fetching the resume details sing bakend url
  ...
  //uPDATING THE THUMBNAIL REFERENCE HELPINg IN CHOOSING PREWIEW AND HELP IN DAONLOADING THE RESUME
  ...
  //helps in  updating the resume at server side using thumbnail
          ...
          <div className="text-center mb-4">
            <div className={statusStyles.modalBadge}>
              <div className={iconStyles.pulseDot}>
                <span>Completeion: {completionPercentage}%</span>
              </div>
            </div>
